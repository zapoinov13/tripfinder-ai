...
const destinations = [
  { id: "turkey", country: "Турция", city: "Анталия", flag: "🇹🇷", blurb: "Пляжи, all inclusive", tours: 1284 },
  ...
  { id: "egypt", country: "Египет", city: "Хургада", flag: "🇪🇬", blurb: "Красное море", tours: 651 },
  ...
  { id: "georgia", country: "Грузия", city: "Батуми", flag: "🇬🇪", blurb: "Море и горы", tours: 312 },
  { id: "qatar", country: "Катар", city: "Доха", flag: "🇶🇦", blurb: "Новые отели", tours: 164 },
  { id: "srilanka", country: "Шри-Ланка", city: "Бентота", flag: "🇱🇰", blurb: "Океан и чай", tours: 208 },
...
const hotels = hotelSeed.map(([name, destinationId, city, stars, rating, district, beachLine, distanceToSea, amenities], i) => {
