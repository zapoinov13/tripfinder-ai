...
export const destGalleries: Record<string, string[]> = {
  uae: [
    ...
    dubaiSafari,
    dubaiOldCity,
    u("photo-1512453973775-ab3349d8b7c9"),
    u("photo-1518683977397-5f0617615859"),
    u("photo-1526495124232-a04e0c4aabe8"),
  ...
  turkey: [
    ...
    u("photo-1527838832700-50597590b5c8"),
    u("photo-1601581875301-3e922430d4f3"),
    u("photo-1566073771259-6a8506099945"),
    u("photo-1507525428034-b723cf961d3e"),
    u("photo-1571896349842-dea6dae4c3b0"),
    u("photo-1540541338287-41700207dee6"),
  ...
  thailand: [
    destThailand,
    u("photo-1552465011-b4e21bf6e765"),
    u("photo-1537953773345-d172ccf13cf1"),
    u("photo-1528183421280-13476f7d2d83"),
  ...
  egypt: [
    destEgypt,
    u("photo-1539650116574-8efeb43e9280"),
    u("photo-1568322445389-f64ac9fda63e"),
  ...
  maldives: [
    destMaldives,
    u("photo-1514282401047-d79a71a5906e"),
    u("photo-1439066615861-d1af74d74000"),
    u("photo-1573843981267-be1999ff39cd"),
  ...
  qatar: [
    ...
    u("photo-1596422846543-75c8b64708c6"),
    destUae,
    dubaiDowntown,
    u("photo-1512453973775-ab3349d8b7c9"),
    u("photo-1564501049412-61c2a308b431"),
  ...
  srilanka: [
    ...
    u("photo-1588258148848-2862300c5b0e"),
    destThailand,
    u("photo-1507525428034-b723cf961d3e"),
    u("photo-1510414842594-a61c69b5ae57"),
    u("photo-1520250497591-112f2f40a3f4"),
...
const cityPhotos: Record<string, string> = {
  ...
  Анталия: destTurkey,
  Алания: u("photo-1601581875301-3e922430d4f3"),
  Белек: u("photo-1571896349842-dea6dae4c3b0"),
  ...
  Доха: u("photo-1596422846543-75c8b64708c6"),
  "Аль-Хор": u("photo-1609137144813-7d9921338f24"),
  Бентота: u("photo-1540202404-a2f29016b523"),
  Хиккадува: u("photo-1588258148848-2862300c5b0e"),
...
const excursionCovers: Record<string, string[]> = {
  ...
  "exc-yacht": [dubaiYacht, u("photo-1567899378494-47b22a2ae96d"), u("photo-1469796466631-cfc704789d51"), u("photo-1476514525535-07fb3b4ae5f1")],
  "exc-burj": [dubaiDowntown, u("photo-1512453973775-ab3349d8b7c9"), u("photo-1518683977397-5f0617615859"), u("photo-1489515217757-5fd1be406fef")],
  ...
  "exc-transfer-dxb": [dubaiHero, u("photo-1436491865332-7a61a10969f4"), dubaiDowntown],
  "exc-abudhabi": [u("photo-1512632578888-169bbbc64f33"), destUae, u("photo-1609137144813-7d9921338f24")],
  "exc-ferrari": [u("photo-1577717903315-1691ae25ab3f"), u("photo-1518683977397-5f0617615859"), dubaiFamily],
  "exc-louvre": [u("photo-1512632578888-169bbbc64f33"), u("photo-1609137144813-7d9921338f24"), destUae],
  "exc-sharjah": [dubaiOldCity, destUae, u("photo-1512453973775-ab3349d8b7c9")],
  ...
  "exc-antalya-yacht": [u("photo-1567899378494-47b22a2ae96d"), u("photo-1476514525535-07fb3b4ae5f1"), destTurkey],
  "exc-antalya-land": [u("photo-1576678927484-cc907957088c"), dubaiFamily, hotel2],
  "exc-alanya-castle": [u("photo-1601581875301-3e922430d4f3"), destTurkey, u("photo-1541432901042-2d8bd64b4a9b")],
  "exc-alanya-boat": [u("photo-1476514525535-07fb3b4ae5f1"), u("photo-1567899378494-47b22a2ae96d"), u("photo-1507525428034-b723cf961d3e")],
  "exc-kemer-oly": [u("photo-1506905925346-21bda4d32df4"), destTurkey, u("photo-1527838832700-50597590b5c8")],
  ...
  "exc-bodrum-gulf": [u("photo-1567899378494-47b22a2ae96d"), u("photo-1507525428034-b723cf961d3e"), u("photo-1476514525535-07fb3b4ae5f1")],
  "exc-marmaris-dalyan": [u("photo-1544551763-46a013bb70d5"), destTurkey, u("photo-1507525428034-b723cf961d3e")],
  "exc-phuket-phi": [u("photo-1506665531195-3566af2b4dfa"), destThailand, u("photo-1552465011-b4e21bf6e765")],
  "exc-phuket-old": [u("photo-1528183421280-13476f7d2d83"), destThailand, u("photo-1537953773345-d172ccf13cf1")],
  "exc-phuket-show": [u("photo-1528127269322-539801943592"), destThailand, hotel1],
  "exc-pattaya-alc": [u("photo-1552465011-b4e21bf6e765"), destThailand, u("photo-1528183421280-13476f7d2d83")],
  "exc-pattaya-islands": [u("photo-1476514525535-07fb3b4ae5f1"), u("photo-1507525428034-b723cf961d3e"), destThailand],
  "exc-krabi-4": [u("photo-1506665531195-3566af2b4dfa"), u("photo-1552465011-b4e21bf6e765"), destThailand],
  "exc-samui-ang": [u("photo-1514282401047-d79a71a5906e"), u("photo-1439066615861-d1af74d74000"), destThailand],
  "exc-hurghada-orange": [u("photo-1591604129939-f1efa4d9f7fa"), destEgypt, u("photo-1544551763-46a013bb70d5")],
  "exc-hurghada-luxor": [u("photo-1539650116574-8efeb43e9280"), u("photo-1568322445389-f64ac9fda63e"), destEgypt],
  ...
  "exc-sharm-colored": [u("photo-1568322445389-f64ac9fda63e"), destEgypt, u("photo-1506905925346-21bda4d32df4")],
  "exc-marsa-dolphins": [u("photo-1544551763-46a013bb70d5"), destEgypt, u("photo-1514282401047-d79a71a5906e")],
  ...
  "exc-male-sandbank": [destMaldives, u("photo-1514282401047-d79a71a5906e"), u("photo-1439066615861-d1af74d74000")],
  "exc-male-city": [u("photo-1514282401047-d79a71a5906e"), destMaldives, u("photo-1573843981267-be1999ff39cd")],
  ...
  "exc-doha-museum": [u("photo-1596422846543-75c8b64708c6"), u("photo-1609137144813-7d9921338f24"), destUae],
  "exc-doha-desert": [u("photo-1451337516015-6b6e9a44a8a3"), dubaiSafari, u("photo-1473580044384-7ba9967e16a0")],
  "exc-doha-transfer": [u("photo-1436491865332-7a61a10969f4"), u("photo-1596422846543-75c8b64708c6"), destUae],
  "exc-bentota-river": [u("photo-1540202404-a2f29016b523"), destThailand, u("photo-1476514525535-07fb3b4ae5f1")],
  "exc-hikka-whale": [u("photo-1544551763-46a013bb70d5"), u("photo-1588258148848-2862300c5b0e"), destThailand],
