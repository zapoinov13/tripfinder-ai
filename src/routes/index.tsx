  ...
  return (
    <SiteLayout>
      {/* Первый экран телефона — ровно это: обложка, подбор и разделы.
          ...
          высоту экрана за вычетом шапки, таб-бара и обоих вырезов. Вырез
          сверху вычитать обязательно: `100svh` считается от края экрана, а
          блок начинается ниже — под шапкой, которую этот вырез отодвинул.
          Без него блок ровно на высоту выреза длиннее места, где помещается,
          и заголовок следующего раздела выглядывает над таб-баром.
      ...
      <div className="flex min-h-[calc(100svh-8.5rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] flex-col md:min-h-0">
