...
> = {
  START: {
    ...
    included: [
      ...
      "Добавление туров вручную и со своего сайта",
  ...
  BUSINESS: {
    title: "Бизнес",
    forWhom: "Если заявок много и хотите видеть, какие туры продаются.",
    included: [
      "Всё из тарифа «Старт»",
      "Полная аналитика: воронка, города, конверсия",
      "Удобнее вести много туров сразу",
      "Отметки в поиске при продвижении карточки",
    ],
    highlight: "Чаще всего выбирают",
  },
  PRO: {
    title: "Про",
    forWhom: "Если нужен максимум показов и место на главной.",
    included: [
      "Всё из тарифа «Бизнес»",
      "Приоритет в поиске среди похожих туров",
      "Карточка на главной странице TourGo",
      "Все виды продвижения без ограничений по пакету",
    ],
  },
};
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Разница в лимите туров и в том, насколько заметны ваши карточки.
      </p>
            ...
            <table className="w-full min-w-[420px] text-left">
              ...
              <tbody className="[&_td]:py-2 [&_td]:pr-3">
                {[
                  ...
                  ["Страница компании", "Да", "Да", "Да"],
                  ["Аналитика", "Базовая", "Полная", "Полная"],
                  ["Продвижение карточки", "Отдельно", "Отдельно", "Отдельно"],
