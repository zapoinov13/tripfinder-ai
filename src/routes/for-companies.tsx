...
const cabinet = [
  ...
  { icon: Upload, title: "Туры", text: "Вручную, со сайта, из Telegram или автозагрузкой каталога по API." },
...
const faq = [
  ...
  {
    q: "Как добавить туры?",
    a: "Вручную, ссылкой на страницу сайта, текстом из Telegram или через Supplier Feed (тарифы «Бизнес» и «Про») — каталог обновляется у вас, TourGo только зеркалит.",
  },
  {
    q: "Нужно ли вести туры и у себя, и в TourGo?",
    a: "Нет, если подключите feed или будете присылать посты/ссылки. На «Старте» карточки собираются из ссылки или Telegram и один раз проверяются. На «Бизнесе» цены и наличие подтягиваются сами.",
  },
  {
