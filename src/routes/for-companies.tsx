...
const faq = [
  ...
  },
  {
    ...
    a: "Да. В кабинете раздел «Услуги»: вкладки Жильё, Авто и Спорт. Вставляете ссылку и текст bio. TourGo собирает карточку, вы проверяете и публикуете. Полный автоскрейп Instagram без Meta API недоступен.",
  },
  {
