...
const faq = [
  ...
  {
    q: "Можно добавить спорт из Instagram?",
    a: "Да. В кабинете раздел «Спорт»: вставляете ссылку на профиль или пост и текст bio. TourGo собирает карточку, вы проверяете и публикуете в витрине. Полный автоскрейп Instagram без Meta API недоступен, поэтому нужен текст рядом со ссылкой.",
  },
  {
