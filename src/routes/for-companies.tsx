...
const flow = [
  {
    ...
    text: "Куда, когда, сколько человек и бюджет. Одна форма вместо десятка чатов в WhatsApp.",
  },
  {
    n: "2",
    title: "Вы видите её в кабинете",
    text: "Только заявки по вашим странам и услугам. Отправляете цену, отель и что входит.",
  },
  {
    n: "3",
    title: "Турист выбирает вас",
    text: "Сравнивает ваши условия с другими. Если выбрал, пишет вам. Оплата идёт вам, не TourGo.",
  },
];

const cabinet = [
  { icon: Inbox, title: "Заявки", text: "Новые запросы туристов и статус вашего ответа." },
  { icon: Send, title: "Предложения", text: "Ваши цены: что турист выбрал, что ещё ждёт ответа." },
  {
    icon: Upload,
    title: "Каталог и услуги",
    text: "Туры вручную, с сайта или из Telegram. Спорт: из Instagram или сайта за пару минут.",
  },
  ...
  },
  {
    icon: BadgeCheck,
    title: "Знак проверки",
    text: "После документов туристы видят, что вы проверенная компания.",
  },
];

const startSteps = [
  { title: "Ваши контакты", text: "Имя, телефон, почта: это вы как контактное лицо." },
  ...
  {
    title: "Документы",
    text: "Регистрация и лицензия, если нужна. Кабинет открыт уже во время проверки.",
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: "Турист платит вашей компании. TourGo не принимает оплату за тур и не забирает комиссию с брони.",
  },
  {
    q: "Это платно для турфирмы?",
    a: "Размещение туров и ответы на заявки на старте бесплатные. Продвижение в поиске и на главной, по желанию, отдельно.",
  },
  {
    q: "Можно работать до проверки документов?",
    a: "Да. Сразу добавляете туры и отвечаете на заявки. Знак «Проверенная компания» появится после проверки.",
  },
  {
    q: "Как добавить туры, не ведя два кабинета?",
    a: "Вручную, ссылкой на сайт, текстом из Telegram или через Supplier Feed на тарифах «Бизнес» и «Про»: каталог обновляется у вас, TourGo только зеркалит.",
  },
  {
    q: "Можно добавить спорт, жильё или авто из Instagram?",
    a: "Да. В кабинете раздел «Услуги». Для обычного сайта сервер сам читает HTML и собирает карточку. Для Instagram чаще нужен bio или текст поста рядом со ссылкой: Meta не отдаёт профиль без API.",
  },
  {
    q: "Как добавить тур со своего сайта?",
    a: "В кабинете «Туры» → со сайта. Сервер открывает страницу, вытаскивает название, цену и описание. Вы проверяете черновик и публикуете.",
  },
  {
    q: "Нужно ли дублировать каталог у себя и в TourGo?",
    a: "Нет, если подключите feed или будете присылать посты и ссылки. На «Старте» карточка собирается из ссылки или Telegram и один раз проверяется вами.",
  },
  {
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="container-page absolute inset-x-0 top-0 flex h-full flex-col justify-end pb-8 pt-24">
          ...
          <p className="mt-3 max-w-xl text-sm text-primary-foreground/80 md:text-base">
            ...
            вас. Клиент ваш, оплата вам, без комиссии TourGo с тура.
          </p>
