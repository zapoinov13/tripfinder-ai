...
export const Route = createFileRoute("/search")({
  ...
  head: () =>
    seo({
      title: "Поиск туров: цены турфирм по датам и бюджету",
      description:
        "Подберите тур по датам, бюджету, отелю и питанию. Горящие предложения и цены разных турфирм рядом — сравните и напишите компании напрямую.",
      path: "/search",
    }),
