...
const paths = [
  {
    ...
    text: "Страна, даты, отель и цена. Сравниваете карточки и открываете предложение компании.",
  },
  {
    to: "/excursions" as const,
    icon: MapPinned,
    title: "Экскурсии и развлечения",
    text: "Сначала страна и город, потом только доступные программы на месте.",
  },
  {
    to: "/assistance" as const,
    icon: LifeBuoy,
    title: "Помощь в поездке",
    text: "Уже в другой стране? Опишите, что нужно сегодня. Компании рядом пришлют цены.",
  },
];

const steps = [
  { n: "1", title: "Выберите путь", text: "Ищете сами, оставляете заявку или просите помощь на месте." },
  { n: "2", title: "Смотрите предложения", text: "Цена, отель, питание и компания рядом. Без десяти чатов." },
  { n: "3", title: "Сравниваете", text: "Несколько турфирм на одну задачу. Выбираете, что подходит." },
  { n: "4", title: "Платите компании", text: "TourGo не берёт оплату за тур. Договор и деньги у выбранной фирмы." },
];
      ...
      <div className="container-page py-10 md:py-14">
        ...
        >
          ...
          <div className="rounded-2xl bg-secondary/60 p-5">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Если вы уже в поездке, откройте «Помощь в поездке» и оставьте задачу компаниям на месте.
              Это быстрее, чем ждать общую почту.
            </p>
