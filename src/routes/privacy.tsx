      ...
      <div className="container-page max-w-3xl py-10 md:py-14">
        ...
        <div className="prose prose-sm mt-8 max-w-none space-y-4 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>
            ...
            которых выбрали. Мы не продаём и не передаём контакты третьим лицам для рекламы.
          </p>
          ...
          <p>
            В мобильном приложении мы можем отправлять уведомления о новых предложениях и
            сообщениях. Их можно отключить в настройках телефона или профиля.
          </p>
        </div>
