...
export const Route = createFileRoute("/assistance")({
  ...
  head: () =>
    seo({
      title: "Помощь в поездке: трансфер, гид и водитель на русском",
      description:
        "Трансфер из аэропорта, русскоговорящий гид, водитель, бронь столика, фотограф. Опишите задачу — местные компании пришлют цену.",
      path: "/assistance",
    }),
