...
const needs = [
  {
    ...
    wish: (place: string) =>
      `Мы сейчас в ${place}. Нужна машина с русскоговорящим водителем на день.`,
  },
  {
    id: "transfer",
    icon: Plane,
    ...
    wish: (place: string) =>
      `Мы сейчас в ${place}. Нужен трансфер в аэропорт. Нас двое взрослых, с багажом.`,
  },
  {
    id: "guide",
    icon: MessageSquare,
  ...
  },
  {
    ...
    wish: (place: string) =>
      `Мы сейчас в ${place}. Хотим прогулку на яхте или катере на вечер, до 6 человек.`,
  },
  {
    id: "tickets",
    icon: Ticket,
    ...
    wish: (place: string) =>
      `Мы сейчас в ${place}. Нужны билеты в парк или на шоу на завтра, семья из четырёх человек.`,
  },
];
