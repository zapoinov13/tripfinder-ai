...
export type Organization = {
   ...
   *
   * Раньше это выводили из списка услуг. Догадка ломается на пустом списке
   * (компания только зарегистрировалась) и врёт на смешанном. А от категории
   * зависит весь кабинет: какие разделы видно и какие заявки приходят.
   */
  category?: string;
  /**
